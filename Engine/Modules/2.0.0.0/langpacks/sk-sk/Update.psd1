ConvertFrom-StringData -StringData @'
	...
	ChkUpdate                 = Skontrolujte aktualizácie
	...
	ForceUpdate               = Vynútiť kontrolu a aktualizáciu
	...
	UpdateQueryingTime        = Kontrola dostupnosti najnovšej verzie Pripojenie trvalo {0} milisekúnd.
	...
	UpdateUnpacking           = Rozopínanie
	UpdateDone                = Úspešne aktualizované!
	UpdateDoneRefresh         = Po dokončení aktualizácie sa vykoná spracovanie funkcie.
	...
	Auto_Update_Allow         = Povoliť automatické kontroly aktualizácií na pozadí
	Auto_Update_New_Allow     = Keď sa zistia nové aktualizácie, povoliť automatické aktualizácie.
	Auto_Check_Time           = Hodiny, interval medzi automatickými kontrolami
	Auto_Last_Check_Time      = Čas poslednej automatickej kontroly aktualizácií
	Auto_Next_Check_Time      = Nie viac ako {0} hodín, čas ďalšej kontroly
	Auto_First_Check          = Žiadna kontrola aktualizácií nebola vykonaná, vykoná sa prvá kontrola aktualizácií
	Auto_Update_Last_status   = Stav poslednej aktualizácie
	Auto_Update_IsLatest      = Používate najnovšiu verziu {0}.
'@