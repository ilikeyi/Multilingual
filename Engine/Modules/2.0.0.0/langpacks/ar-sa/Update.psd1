ConvertFrom-StringData -StringData @'
	...
	ForceUpdate               = فرض التحقق والتحديث
	...
	UpdateQueryingTime        = التحقق لمعرفة ما إذا كان الإصدار الأحدث متاحًا، يستغرق الاتصال وقتًا {0} ميلي ثانية
	...
	UpdateMinimumVersion      = تلبية الحد الأدنى من متطلبات إصدار التحديث، الحد الأدنى من الإصدار المطلوب: {0}
	...
	Auto_Update_IsLatest      = {0} أنت تقوم بتشغيل أحدث إصدار من 
'@