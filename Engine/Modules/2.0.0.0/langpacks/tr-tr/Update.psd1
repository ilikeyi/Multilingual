ConvertFrom-StringData -StringData @'
	...
	ChkUpdate                 = Güncellemeleri kontrol edin
	...
	UpdateQueryingTime        = En son sürümün mevcut olup olmadığının kontrol edilmesi {0} milisaniye sürdü.
	...
	UpdateUnpacking           = Sıkıştırmayı açma
	UpdateDone                = Başarıyla güncellendi!
	UpdateDoneRefresh         = Güncelleme tamamlandıktan sonra fonksiyon işlemi gerçekleştirilir.
	...
	Auto_Update_New_Allow     = Yeni güncellemeler algılandığında otomatik güncellemelere izin ver
	Auto_Check_Time           = Otomatik güncellemeler arasındaki süre ( saat cinsinden )
	Auto_Last_Check_Time      = Son otomatik güncelleme kontrol zamanı
	Auto_Next_Check_Time      = En fazla {0} saat önce, sonraki kontrol zamanı
	Auto_First_Check          = Güncelleme kontrolü yapılmadı, ilk güncelleme kontrolü yapılacak
	Auto_Update_Last_status   = Son güncelleme durumu
	Auto_Update_IsLatest      = {0} nin en son sürümünü kullanıyorsunuz.
'@