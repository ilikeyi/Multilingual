...
("Windows Defender Control",                              软件包名称
 ...
 - 默认
   dfControl.ini 复制后更改为 dfControl.Default.ini

 - 英文
   dfControl.ini 复制后更改为 dfControl.en-US.ini
   打开 dfControl.en-US.ini，将 Language=Auto 修改为 Language=English

 - 中文
   dfControl.ini 复制后更改为 dfControl.zh-CN.ini
   打开 dfControl.zh-CN.ini，将 Language=Auto 修改为 Language=Chinese_简体中文

   制作完成后删除 dfControl.ini。
...
$app = @(
	...
	("WPS Office",
	 ...
	 "安装包\办公软件",
	 "",
	 "https://official-package.wpscdn.cn/wps/download/W.P.S.11294.12012.2019.exe",
	 "",
	 "",
	 "W.P.S*",
	 "",
