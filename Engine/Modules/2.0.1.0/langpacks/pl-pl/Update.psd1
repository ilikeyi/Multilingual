ConvertFrom-StringData -StringData @'
	...
	UpdateSilent              = Aktualizuj w trybie cichym, gdy aktualizacje są dostępne
	UpdateClean               = Pozwól na czyszczenie starych wersji w wolnym czasie
	ForceUpdate               = Wymuś sprawdzenie i aktualizację
	UpdateReset               = Zresetuj to rozwiązanie
	...
	UpdateQueryingTime        = Sprawdzanie, czy dostępna jest najnowsza wersja. Połączenie trwało {0} milisekund.
	...
	UpdateUnpacking           = Rozpakowanie
	UpdateDone                = Zaktualizowano pomyślnie!
	UpdateDoneRefresh         = Po zakończeniu aktualizacji następuje przetwarzanie funkcji.
	...
	Auto_Update_Allow         = Zezwalaj na automatyczne sprawdzanie aktualizacji w tle
	Auto_Update_New_Allow     = W przypadku wykrycia nowych aktualizacji zezwól na automatyczne aktualizacje.
	Auto_Check_Time           = Godziny, odstęp między automatycznymi sprawdzeniami
	Auto_Last_Check_Time      = Czas ostatniego automatycznego sprawdzenia aktualizacji
	Auto_Next_Check_Time      = Nie więcej niż {0} godzin, czas następnego sprawdzenia
	Auto_First_Check          = Nie wykonano sprawdzania aktualizacji, zostanie wykonane pierwsze sprawdzenie aktualizacji
	Auto_Update_Last_status   = Status ostatniej aktualizacji
	Auto_Update_IsLatest      = Już jest to najnowsza wersja.
'@