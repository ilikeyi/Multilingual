ConvertFrom-StringData -StringData @'
	...
	UpdateQueryingTime        = Controleren of de nieuwste versie beschikbaar is. De verbinding duurde {0} milliseconden.
	...
	UpdateUnpacking           = Uitpakken
	UpdateDone                = Succesvol bijgewerkt!
	UpdateDoneRefresh         = Nadat de update is voltooid, wordt de functieverwerking uitgevoerd.
	...
	Auto_Update_Allow         = Automatische achtergrondcontrole op updates toestaan
	Auto_Update_New_Allow     = Wanneer nieuwe updates worden gedetecteerd, sta automatische updates toe.
	Auto_Check_Time           = Uren, interval tussen automatische controles
	Auto_Last_Check_Time      = Tijdstip laatste automatische updatecontrole
	Auto_Next_Check_Time      = Niet meer dan {0} uur, tijdstip volgende controle
	Auto_First_Check          = Geen updatecontrole uitgevoerd, de eerste updatecontrole wordt uitgevoerd
	Auto_Update_Last_status   = Laatste updatestatus
	Auto_Update_IsLatest      = Al de nieuwste versie.
'@