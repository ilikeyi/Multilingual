...
$AvailableLanguages = @(
	...
	@{
		...
		Language = @{
			...
			UpdateAvailable          = "Egoera: Eskuragarri"
			UpdateUnavailable        = "Egoera: Ez dago erabilgarri"
	...
	@{
		...
		Language = @{
			...
			UpdateAvailable          = "Estado: Dispoñible"
			UpdateUnavailable        = "Estado: Non dispoñible"
	...
	@{
		...
		Language = @{
			...
			UpdateAvailable          = "Status: Tersedia"
			UpdateUnavailable        = "Status: Tidak tersedia"
	...
	@{
		...
		Language = @{
			...
			UpdateAvailable          = "Tình trạng: Có sẵn"
			UpdateUnavailable        = "Tình trạng: Không có sẵn"
