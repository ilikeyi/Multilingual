ConvertFrom-StringData -StringData @'
	...
	ForceUpdate               = Pakota tarkistus ja päivitys
	...
	UpdateQueryingTime        = Uusimman version tarkistaminen kesti {0} millisekuntia.
	...
	UpdateCurrent             = Nykyinen versio
	UpdateLatest              = Viimeisin saatavilla oleva versio
	UpdateNewLatest           = Tutustu uusiin saatavilla oleviin versioihin!
	UpdateSkipUpdateCheck     = Esimääritetty käytäntö ei salli automaattisten päivitysten suorittamista ensimmäistä kertaa.
	UpdateTimeUsed            = Käytetty aika
	UpdatePostProc            = Jälkikäsittely
	UpdateNotExecuted         = Ei teloitettu
	UpdateNoPost              = Jälkikäsittelytehtävää ei löydy
	UpdateUnpacking           = Purkaminen
	UpdateDone                = Päivitetty onnistuneesti!
	UpdateDoneRefresh         = Kun päivitys on valmis, toimintojen käsittely suoritetaan.
	...
	Auto_Update_Allow         = Salli automaattiset taustapäivitysten tarkistukset
	Auto_Update_New_Allow     = Salli automaattiset päivitykset, kun uusia päivityksiä havaitaan.
	Auto_Check_Time           = Tunnit, automaattisten tarkistusten välinen aika
	Auto_Last_Check_Time      = Viimeisimmän automaattisen päivitysten tarkistuksen aika
	Auto_Next_Check_Time      = Enintään {0} tuntia, seuraavan tarkistuksen aika
	Auto_First_Check          = Päivitystarkistusta ei suoritettu, suoritetaan ensimmäinen päivitystarkistus
	Auto_Update_Last_status   = Viimeisimmän päivityksen tila
	Auto_Update_IsLatest      = Käytät {0} -sovelluksen uusinta versiota.
'@