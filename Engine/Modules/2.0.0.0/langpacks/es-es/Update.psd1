ConvertFrom-StringData -StringData @'
	...
	ForceUpdate               = Forzar verificación y actualización
	...
	UpdateQueryingTime        = Comprobar si la última versión está disponible. La conexión tardó {0} milisegundos.
	...
	UpdateTimeUsed            = Tiempo empleado
	...
	Auto_Update_IsLatest      = Estás ejecutando la última versión de {0}.
'@